...
##
inicio = time.time()
for INFILE_S in sorted(glob.glob('/home/federico/work/DS3/observacion/Marcelo/TCCP1/*c01*'), reverse=False):
    print(INFILE_S)
    sz = os.path.getsize(INFILE_S)
    #print(sz)
    rcfile = int(sz/4000176.0)
    print("sec obs_C01 files:", rcfile)
#   
#    fileout = "header_S_C1.txt"
...
#    f = open('/home/federico/work/DS3/observacion/Marcelo/j349/TTCCP/outputs/Sol/' + fileout,'w')
#    f.write(labels) 
    ##
    with open(INFILE_S, 'rb') as fd:
        b = ConstBitStream(fd)  
